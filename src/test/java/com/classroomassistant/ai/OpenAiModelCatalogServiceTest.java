...
class OpenAiModelCatalogServiceTest {
    ...
    @Test
    void normalizeModelsEndpoint_supportsBaseWithoutV1() {
    ...
    @Test
    void normalizeModelsEndpoint_supportsBaseWithV1() {
    ...
    @Test
    void parseModelNames_extractsAndSortsDistinctIds() {
        ...
        assertEquals("gpt-4o-mini", models.get(1));
    }

    @Test
    void parseModelNames_handlesInvalidJson() {
        List<String> models = OpenAiModelCatalogService.parseModelNames("not-json");
        assertTrue(models.isEmpty());
    }

    @Test
    void applyAuthHeader_usesProviderSpecificHeaders() throws Exception {
        ...
        var method = OpenAiModelCatalogService.class.getDeclaredMethod(
                ...
                LLMConfig.ModelType.class,
                String.class);
        method.setAccessible(true);

        HttpRequest.Builder anthropicBuilder = HttpRequest.newBuilder();
        method.invoke(service, anthropicBuilder, LLMConfig.ModelType.ANTHROPIC, "anthropic-key");
        ...
        method.invoke(service, azureBuilder, LLMConfig.ModelType.AZURE_OPENAI, "azure-key");
        ...
        method.invoke(service, replicateBuilder, LLMConfig.ModelType.REPLICATE, "replicate-key");
        ...
        method.invoke(service, openAiBuilder, LLMConfig.ModelType.OPENAI, "openai-key");
    ...
    @Test
    void buildHttpError_usesHelpfulMessageFor401() throws Exception {
        OpenAiModelCatalogService service = new OpenAiModelCatalogService();
        var method = OpenAiModelCatalogService.class.getDeclaredMethod(
                "buildHttpError",
                LLMConfig.ModelType.class,
        ...
        IllegalStateException ex = (IllegalStateException) method.invoke(service, LLMConfig.ModelType.ANTHROPIC, 401);
